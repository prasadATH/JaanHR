...
<div class="relative">
    <!-- Background Image -->
    <img src="./assetes/image/bg1.png" class="w-[800px] h-full">
    ...
    <div class="w-1/2 h-full bg-white flex flex-col justify-center items-center">
        ...
        <div class="w-1/2 p-8">
            ...
            <div class="mb-6">
                ...
                <input type="password" id="password" name="password" class="w-full px-4 py-4 mt-1 border-2 border-[#1C1B1F80] rounded-xl focus:outline-none focus:ring focus:ring-indigo-300" required>
            </div>
            <div class="mb-6">
                <label for="password" class="block text-xl font-bold text-black nunito- ">Confirm Password</label>
                <input type="password" id="password" name="password" class="w-full px-4 py-4 mt-1 border-2 border-[#1C1B1F80] rounded-xl focus:outline-none focus:ring focus:ring-indigo-300" required>
            </div>
            <div class="w-full space-y-4 pt-8">
            <button type="submit" class="w-full px-4 py-4 text-white text-2xl font-bold nunito- rounded-xl bg-gradient-to-r from-[#184E77] to-[#52B69A] hover:opacity-90 focus:outline-none focus:ring focus:ring-[#52B69A]">Reset Password</button>
            </div>
