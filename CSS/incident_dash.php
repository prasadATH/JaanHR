...
<div class="w-full pt-8">
  ...
  <div class="flex items-center justify-between w-full">
    <div class="flex ">
    <p class="text-6xl font-bold text-black nunito-">Incident</p>
    </div>
  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-3 nunito-">
    ...
    <button class="flex items-center justify-center min-w-[165px] py-2 text-[#184E77] border-2 border-[#184E77] text-2xl bg-white rounded-xl shadow-sm hover:from-[#1B5A8A] hover:to-[#60C3A8]">
...
<table class="w-full nunito- border-separate" style="border-spacing: 0 10px;">
  <thead>
    <tr class="bg-white">
      ...
      <th class="text-xl text-black font-bold px-4 py-2 text-right align-middle">Supporting Docs.</th>
    </tr>
  </thead>
  <tbody>
    <tr class="hover:shadow hover:rounded-xl font-bold">
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966] rounded-l-xl">
        Jenny Wilson Perera
        <p class="text-sm">235674</p>
      </td>
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">Behavioral</td>
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">23.10.2024</td>
      <td class="text-xl px-4 py-2 text-center bg-[#D9D9D966]">
        <p class="text-[#47B439] border-2 border-[#47B439] bg-[#47B43933] rounded-xl px-2 py-1 shadow-sm">Resolved</p>
      </td>
      <td class="text-xl text-[#3569C3] px-4 py-2 text-right align-middle bg-[#D9D9D966]">
        <p>Billing Details.PDF</p>
        <p>Billing Details.PDF</p>
      </td>
      <td class="text-center align-middle bg-[#D9D9D966] rounded-r-xl">
    ...
    <tr class="hover:shadow hover:rounded-xl font-bold">
      ...
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">Safety</td>
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">23.10.2024</td>
      <td class="text-xl px-4 py-2 text-center bg-[#D9D9D966]">
        <p class="text-[#FFBF00] border-2 border-[#FFBF00] bg-[#FFBF0033] rounded-xl px-2 py-1 shadow-sm">Open</p>
      </td>
      <td class="text-xl text-[#3569C3] px-4 py-2 text-right align-middle bg-[#D9D9D966]">
        <p>Billing Details.PDF</p>
        <p>Billing Details.PDF</p>
    ...
    <tr class="hover:shadow hover:rounded-xl font-bold">
      ...
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">Performance</td>
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">23.10.2024</td>
      <td class="text-xl px-4 py-2 text-center bg-[#D9D9D966]">
        <p class="text-[#47B439] border-2 border-[#47B439] bg-[#47B43933] rounded-xl px-2 py-1 shadow-sm">Resolved</p>
      </td>
