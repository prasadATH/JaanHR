    ...
    <div class="w-full flex flex-col justify-start items-center bg-white p-8 rounded-3xl space-y-8">
      ...
      <div class="w-full mx-auto p-6">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            <label for="employee-id" class="block text-xl text-black font-bold">Type of Incident :</label>
            <input
              type="text"
              id="employee-id"
              placeholder="Enter your Employee ID"
          ...
          <!-- Claim Date -->
          <div>
            <label for="claim-date" class="block text-xl text-black font-bold">Date of Incident :</label>
            <input
              type="date"
              id="claim-date"
          ...
          <!-- Status -->
          <div>
            <label for="status" class="block text-xl text-black font-bold">Incident Status :</label>
            <input
              type="text"
              id="status"
