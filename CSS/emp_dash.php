...
<div class="grid items-center w-full grid-cols-1 gap-8 pt-8 pb-8 md:grid-cols-4">
  <div class="border-2 border-[#00000066] p-8 space-y-4 rounded-3xl">
    <div class="flex items-center justify-center w-full">
      ...
      <div class="flex flex-col items-center justify-center w-1/2 pt-4 space-y-8">
        ...
        <div class="flex flex-col items-center justify-start w-full h-1/2">
        <p class=" text-[#00000080] nunito-">Employee ID</p>
        <p class="text-black nunito-">23456709</p>
        </div>
      </div>
    </div>
    <div class="flex flex-col w-full pt-4 space-y-2">
      <p class="text-5xl font-bold text-black nunito-">Jenny Wilson</p>
    ...
    <div class="flex items-center justify-between w-full">
      <div class="flex flex-col w-full">
        ...
        <p class="text-xl font-bold text-black nunito-">Design Team</p>
      </div>
      <div class="flex flex-col w-full">
        <p class="text-xl nunito- text-[#00000080] font-bold">Hired Date </p>
        <p class="text-xl font-bold text-black nunito-">27 / 09 / 2023</p>
      </div>
    ...
    <div class="flex flex-col items-start justify-start w-full space-y-4">
      ...
      <div class="flex items-center justify-center w-8 h-8 p-1 border border-black rounded-full">
        <p class="text-xl"><i class="ri-mail-line"></i></p>
        </div>
      <p class="font-bold text-black nunito-">userhumanresources@gmail.com</p>
      </div>
      <div class="flex items-center justify-start w-full space-x-2">
      <div class="flex items-center justify-center w-8 h-8 p-1 border border-black rounded-full">
        <p class="text-xl"><i class="ri-phone-line"></i></p>
        </div>
        <p class="font-bold text-black nunito-">+94 77 445 9536</p>
      </div>
    </div>
  </div>
  <div class="border-2 border-[#00000066] p-8 space-y-4 rounded-3xl">
