...
<table class="w-full nunito- mt-12 border-separate" style="border-spacing: 0 10px;">
  ...
  <tbody>
    <tr class="hover:shadow hover:rounded-xl font-bold">
      ...
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">Family Emergency</td>
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">23.10.2024</td>
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">23.10.2024</td>
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">5 d 12 hrs</td>
      <td class="text-xl px-4 py-2 text-center bg-[#D9D9D966]">
        <p class="text-[#47B439] border-2 border-[#47B439] bg-[#47B43933] rounded-xl px-2 py-1 shadow-sm">Approved</p>
      </td>
    ...
    <tr class="hover:shadow hover:rounded-xl font-bold">
      ...
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">5 d 12 hrs</td>
      <td class="text-xl px-4 py-2 text-center bg-[#D9D9D966]">
        <p class="text-[#FFBF00] border-2 border-[#FFBF00] bg-[#FFBF0033] rounded-xl px-2 py-1 shadow-sm">Pending</p>
      </td>
      <td class="text-xl text-[#3569C3] px-4 py-2 text-left align-middle bg-[#D9D9D966]">
        <p>Billing Details.PDF</p>
        <p>Billing Details.PDF</p>
    ...
    <tr class="hover:shadow hover:rounded-xl font-bold">
      ...
      <td class="text-xl text-black px-4 py-2 text-left align-middle bg-[#D9D9D966]">5 d 12 hrs</td>
      <td class="text-xl px-4 py-2 text-center bg-[#D9D9D966]">
        <p class="text-[#FF0000] border-2 border-[#FF0000] bg-[#FF000033] rounded-xl px-2 py-1 shadow-sm">Rejected</p>
      </td>
      <td class="text-xl text-[#3569C3] px-4 py-2 text-left align-middle bg-[#D9D9D966]">
        <p>Billing Details.PDF</p>
        <p>Billing Details.PDF</p>
