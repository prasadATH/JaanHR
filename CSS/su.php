...
<div class="relative">
    ...
    <div class="w-1/2 h-full bg-white flex flex-col justify-center items-center">
        ...
        <div class="w-1/2 p-8">
            ...
            <button type="submit" class="w-full px-4 py-4 text-white text-2xl font-bold nunito- rounded-xl bg-gradient-to-r from-[#184E77] to-[#52B69A] hover:opacity-90 focus:outline-none focus:ring focus:ring-[#52B69A]">Login</button>
            </form>
  </div>
    </div>
    <style>
