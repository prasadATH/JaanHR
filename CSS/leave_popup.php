    ...
    <div class="w-full flex flex-col justify-start items-center bg-white p-8 rounded-3xl space-y-8">
      ...
      <div class="w-full mx-auto p-6">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            <label for="employee-id" class="block text-xl text-black font-bold">Leave Type</label>
            <input
              type="text"
              id="employee-id"
              placeholder="Enter your Employee ID"
          ...
          <!-- Amount -->
          <div>
            <label for="amount" class="block text-xl text-black font-bold">Approved By :</label>
            <input
              type="number"
              id="amount"
          ...
          <div>
            <label for="claim-date" class="block text-xl text-black font-bold">Date From :</label>
            <input
              type="date"
              id="claim-date"
          ...
          <div>
            <label for="claim-date" class="block text-xl text-black font-bold">Date To :</label>
            <input
              type="date"
              id="claim-date"
              placeholder="Enter the date here"
